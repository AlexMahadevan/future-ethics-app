...
var SCENARIOS_FALLBACK = [
  {
    ...
    "safeguardPlaceholder": "e.g., Require provenance metadata on every licensed feed that downstream apps must surface to users..."
  },
  {
    "id": 2,
    ...
    "safeguardPlaceholder": "e.g., Refuse licensing to AI assistants that won't surface source attribution and a link back to the original story..."
  },
  {
    "id": 3,
    ...
    "safeguardPlaceholder": "e.g., The editor in chief can override any automated story selection. The override is logged with a reason and reviewed monthly..."
  }
];
